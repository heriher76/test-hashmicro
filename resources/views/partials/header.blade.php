        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand logo_1" href="{{ route('home') }}"> <img src="https://uccareer.id/assets/upload/company/thumbs/thumb300px-17-06-16-11-06-10.png" alt="logo"> </a>
                    <a class="navbar-brand logo_2" href="{{ route('home') }}"> <img src="https://uccareer.id/assets/upload/company/thumbs/thumb300px-17-06-16-11-06-10.png" alt="logo"> </a>
